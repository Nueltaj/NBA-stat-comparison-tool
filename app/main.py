...
from app.stat.routes.base import router as stat_route
...
app = FastAPI(
    ...
    docs_url="/",
    contact={
        "name": "Raji Abdulakeem",
        "url": "https://github.com/Akashiio",
...
app.include_router(stat_route, tags=["Stat Endpoints"])
